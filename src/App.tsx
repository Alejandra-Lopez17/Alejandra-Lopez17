  ...
  return (
    <>
      ...
      <section className="home" id="home">
        <div className="home-content">
          ...
          <p>
            ...
            Apasionada por la innovación tecnológica y el liderazgo de equipos
        ...
        <div className="about-content">
          ...
          <p>
            Soy <strong>Yovana Alejandra Hinestroza Lopez</strong>, Ingeniera de Software
                        y Co-Fundadora & CTO de <strong>Kamello</strong>, una startup tecnológica
                        enfocada en soluciones digitales innovadoras. Con experiencia liderando equipos
                        de desarrollo y diseñando arquitecturas de software escalables.
          </p>
          <p>
            Mi trayectoria incluye desarrollo Full Stack con <strong>Python, Django, React,
            JavaScript, Docker</strong>             y gestión de CRM/ERP como <strong>Salesforce
                        y SAP</strong>. He logrado mejorar la eficiencia de sistemas en un 20% y liderar
                        proyectos end-to-end desde la concepción hasta el despliegue.
          </p>
          <p>
                        Actualmente cursando mi <strong>Bachelor en Ingeniería de Software</strong> en
                        Jala University y constantemente expandiendo mis competencias técnicas
      ...
      <section className="experience section-animate" id="experience">
        <h2 className="heading">Experiencia & <span>Educación</span></h2>
            ...
            <div className="experience-box">
              <div className="experience-content">
                <div className="content">
                  ...
                  <p>
                                        Liderando la visión tecnológica y el equipo de desarrollo de una
                                        startup innovadora. Diseño de arquitectura de software,
                                        toma de decisiones estratégicas y desarrollo full-stack de
                ...
                <div className="content">
                  ...
                  <p>
                    ...
                    y React. Mejora de la eficiencia del sistema en un 20% mediante
                                        optimización de código y arquitectura. Implementación de APIs
                                        REST y gestión de bases de datos SQL.
                  </p>
                </div>
              </div>
              ...
              <div className="experience-content">
                <div className="content">
                  ...
                  <h3>Web Developer - Universidad Tecnológica de Pereira</h3>
                  <p>
                                        Desarrollo web y optimización de plataformas digitales
                                        universitarias. Implementación de soluciones frontend y
                                        backend, mejorando la experiencia de usuario y el
                                        rendimiento de los sistemas académicos.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="experience-box">
              <div className="experience-content">
                <div className="content">
                  ...
                  <h3>Bachelor en Ingeniería de Software</h3>
                  <p>
                                        Jala University - Formación integral en ingeniería de software,
                                        algoritmos, arquitectura de sistemas, metodologías ágiles
              ...
              <div className="experience-content">
                <div className="content">
                  ...
                  <p>
                                        Universidad Tecnológica de Pereira - Especialización en
                                        desarrollo de software, programación web, bases de datos
          ...
          {[
            {
              ...
              description: "Plataforma tecnológica de la startup Kamello. Arquitectura full-stack con Django, React y PostgreSQL.",
            ...
            },
            {
              ...
              description: "Proyecto integral de ingeniería de software demostrando arquitectura, desarrollo y despliegue end-to-end.",
            ...
            },
            {
              ...
              description: "Sistema web empresarial que mejoró la eficiencia operativa en un 20%. Python, Django y SQL.",
            ...
            },
            {
              ...
              description: "Este portafolio web responsivo construido con React, TypeScript y diseño moderno.",
            ...
            },
            {
              ...
              description: "Microservicios y APIs RESTful construidos con Django REST Framework y documentación OpenAPI.",
            ...
            },
            {
              ...
              description: "Integración de Salesforce CRM y SAP ERP para automatización de procesos empresariales.",
      ...
      <section className="contact section-animate" id="contact">
        ...
        <form className="contact-form" onSubmit={(e) => { e.preventDefault(); window.location.href = `mailto:alejandralopez170723@gmail.com?subject=Contacto desde Portfolio&body=${encodeURIComponent((new FormData(e.currentTarget).get('message') as string) || '')}`; }}>
          <div className="input-box">
            <input type="text" name="name" placeholder="Nombre Completo" required />
            <input type="email" name="email" placeholder="Tu Email" required />
          </div>
          <input type="text" name="phone" placeholder="Tu Teléfono" className="contact-phone" />
